...
const products = [
  {
    ...
    price: "$149,999",
    description: "Direct brain-computer interface with advanced neural mapping capabilities."
  },
  {
    id: 2,
    name: "Bionic Arm Pro",
    ...
    price: "$89,999",
    description: "Military-grade prosthetic with enhanced strength and precision."
  },
  {
    id: 3,
    ...
    price: "$74,999",
    description: "Advanced vision system with night vision and AR capabilities."
  }
];
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
          <div>
            ...
            <p className="text-gray-300 mt-2 max-w-xl">
              Explore our latest cybernetic enhancements designed for superior performance and seamless integration.
            </p>
          </div>
          <Link to="/products" className="mt-4 md:mt-0 flex items-center text-primary-400 hover:text-primary-300 transition-colors">
